...
int main() {
    ...
    double a[9] = {2325.518934999034, 0, 672.1557281523147,
         0, 2321.306568311728, 552.6403724783142,
         0, 0, 1};
    double b[5] = {-0.07937434913667363,
         0.4278376628706723,
         -0.0005608883937399427,
         -0.001812971807705364,
         -1.0829612984259};
    cv::Mat_<double> camera_matrix(3,3,a);
    cv::Mat_<double> distortion_coeffs(5,1,b);


    double r[9] = {-0.001692386118894358, 0.02977563719447569, -0.9995551746946674,
         0.9970706968938083, 0.07648318178390373, 0.0005901693875752093,
         0.07646673279878149, -0.9966261758221454, -0.02981785440313314};
    double t[3] = {-17.66859134765572,
         -1.211967661904279,
         3.304182504491372};
